#!/bin/bash
## Usage example: ./trf_w2l_spect.sh "-b 50 -i units1024_rf65"
...
args_sets=(
    # wav2letter_spect
    "-m wav2letter_spect -l 0"
    "-m wav2letter_spect -l 1"
    "-m wav2letter_spect -l 2"
    "-m wav2letter_spect -l 3"
    "-m wav2letter_spect -l 4"
    "-m wav2letter_spect -l 5"
    "-m wav2letter_spect -l 6"
    "-m wav2letter_spect -l 7"
    "-m wav2letter_spect -l 8"
    "-m wav2letter_spect -l 9"
    "-m wav2letter_spect -l 10"
    "-m wav2letter_spect -l 11"
)

...
# fig, ax = plt.subplots(1,2, figsize=(14,6), sharey=True)
    with open("/scratch/gilbreth/akamsali/Research/Makin/outputs/neuron_corr/ridge_regression/"+ sub + "_" + str(w) +'.csv' ,'a') as f1:
        writer=csv.writer(f1)
        row = R2t + R2v + R2tt
        writer.writerow(row)
        f1.close()

with open("/scratch/gilbreth/akamsali/Research/Makin/outputs/neuron_corr/ridge_regression/" + sub + "_" + str(w), 'w') as f:
